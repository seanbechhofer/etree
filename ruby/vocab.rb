...
VOCAB_AUDIODERIVATIONSTATUS = RDF::URI.new(ETREE + "audioDerivationStatus")
VOCAB_AUDIODERIVATIONORIGINAL = RDF::URI.new(ETREE + "originalAudio")
VOCAB_AUDIODERIVATIONDERIVED = RDF::URI.new(ETREE + "derivedAudio")
VOCAB_AUDIODERIVEDFROM = RDF::URI.new(ETREE + "audioDerivedFrom")
VOCAB_AUDIOFORMAT = RDF::URI.new(ETREE + "audioFormat")
